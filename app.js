...
function buildMedicalDocumentHTML(opts) {
    ...
    return `
        <div class="medical-doc-container" style="background: #ffffff; color: #1e293b; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size: 0.80rem; line-height: 1.30; width: 100%; max-width: 780px; margin: 0 auto; padding: 10px 18px; box-sizing: border-box; page-break-inside: avoid !important; break-inside: avoid !important;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px; padding-bottom: 10px; border-bottom: 1px solid #e2e8f0; min-height: 130px; overflow: visible;">
                <div style="flex: 1.6; max-width: 500px; display: flex; align-items: center; overflow: visible;">
                    ${logoUrl ? `
                        <img src="${logoUrl}" style="width: 380px; max-width: 460px; height: auto; max-height: 220px; object-fit: contain; object-position: left center; display: block; transform: scale(1.4); transform-origin: left center;" alt="Logo">
                    ` : `
                ...
                <div style="text-align: right; flex: 1;">
                    <h1 style="margin: 0 0 4px 0; font-size: 1.35rem; font-weight: 800; color: #0f172a; letter-spacing: -0.02em;">${docTitle}</h1>
